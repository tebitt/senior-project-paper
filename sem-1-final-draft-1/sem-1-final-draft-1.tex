...
\newpage
\input{sections/1-research-background}
\newpage    
\input{sections/2-objective}
\newpage
\input{sections/3-literature-survey}
\newpage
\input{sections/4-project-dev}
\newpage
\input{sections/4.5-hardware}
\newpage
\input{sections/5-testing}
\newpage
